...
#python main.py --model EDSR --scale 2 --save edsr_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --reset --ext 
python main.py --model SEMNET --scale 2 --save edsr_x2 --n_resblocks 32 --n_feats 64 --res_scale 0.1 --reset --ext sep
